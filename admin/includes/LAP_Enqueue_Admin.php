...
class Lap_Enqueue_Admin {
	...
	public function add_plugin_admin_menu() {
		 ...
		 *   For reference: http://codex.wordpress.org/Roles_and_Capabilities
		  ...
		  __( 'Page Title', LAP_TEXTDOMAIN ), LAP_NAME, 'manage_options', LAP_TEXTDOMAIN, array( $this, 'display_plugin_admin_page' )
		  );
		 * 
		 */
		/*
		 ...
		 * 
		 */
		$this->admin_view_page = add_menu_page( __( 'Page Title', LAP_TEXTDOMAIN ), LAP_NAME, 'manage_options', LAP_TEXTDOMAIN, array( $this, 'display_plugin_admin_page' ), 'dashicons-hammer', 90 );
	}
	/**
